...
clr_ref_upos <- read.csv("C:\\Users\\jason\\Google Drive\\GitHub\\packages\\corpuslingr\\data-raw\\clr_ref_upos.csv")%>%
  mutate_all(as.character)


clr_ref_stops <- scan("C:\\Users\\jason\\Google Drive\\GitHub\\packages\\corpuslingr\\data-raw\\clr_ref_stops.txt",what="char",sep="\n")

clr_ref_pos_syntax <- read.csv("C:\\Users\\jason\\Google Drive\\GitHub\\packages\\corpuslingr\\data-raw\\clr_ref_pos_syntax.csv")%>%
  mutate_all(as.character)
